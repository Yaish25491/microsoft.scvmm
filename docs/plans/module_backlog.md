...
- [x] `scvmm_host_network_adapter` - Manage host network adapters (ACA-5713)
- [x] `scvmm_host_network_adapter_info` - Gather host network adapter info (ACA-5717)
...
- [x] `scvmm_logical_network` - Manage logical networks (ACA-5528)
- [x] `scvmm_logical_network_info` - Gather logical network info (ACA-5529)
- [x] `scvmm_vm_network` - Manage VM networks (ACA-5530)
- [x] `scvmm_logical_network_definition` - Manage logical network definitions (ACA-5688)
- [x] `scvmm_logical_network_definition_info` - Gather logical network definition info (ACA-5696)
...
- [x] `scvmm_uplink_port_profile` - Manage uplink port profiles (ACA-5710)
- [x] `scvmm_uplink_port_profile_info` - Gather uplink port profile info (ACA-5714)
...
- [x] `scvmm_servicing_window` - Manage servicing windows (ACA-5742)
- [x] `scvmm_servicing_window_info` - Gather servicing window info (ACA-5744)
- [x] `scvmm_job_info` - Monitor SCVMM jobs (ACA-5745)

## Bare Metal Provisioning (ACA-5678)
- [x] `scvmm_pxe_server` - Manage PXE servers (ACA-5726)
- [x] `scvmm_pxe_server_info` - Gather PXE server info (ACA-5729)
- [x] `scvmm_physical_computer_profile` - Manage physical computer profiles (ACA-5732)
- [x] `scvmm_physical_computer_profile_info` - Gather physical computer profile info (ACA-5736)

## Update & Compliance Management (ACA-5677)
- [x] `scvmm_update_server` - Manage update servers (ACA-5693)
- [x] `scvmm_update_server_info` - Gather update server info (ACA-5707)
- [x] `scvmm_baseline` - Manage baselines (ACA-5711)
- [x] `scvmm_baseline_info` - Gather baseline info (ACA-5715)
...
- [x] `scvmm_hardware_profile_info` - Gather hardware profile info (ACA-5721)
- [x] `scvmm_guest_os_profile` - Manage guest OS profiles (ACA-5735)
- [x] `scvmm_guest_os_profile_info` - Gather guest OS profile info (ACA-5746)
- [x] `scvmm_application_profile` - Manage application profiles (ACA-5747)
- [x] `scvmm_application_profile_info` - Gather application profile info (ACA-5748)
- [x] `scvmm_capability_profile` - Manage capability profiles (ACA-5749)
- [x] `scvmm_capability_profile_info` - Gather capability profile info (ACA-5750)
...
- [x] `scvmm_vm_checkpoint_info` - Gather VM checkpoint info (ACA-5541)
